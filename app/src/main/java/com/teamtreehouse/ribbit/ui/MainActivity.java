            ...
            switch (i) {
                ...
                case 1:
                    ...
                    if (mMediaUri == null) {
                        ...
                        takeVideoIntent.putExtra(MediaStore.EXTRA_DURATION_LIMIT, 5); //10 sec limit
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < mSectionsPagerAdapter.getCount(); i++) {
            ...
            actionBar.addTab(actionBar.newTab()
                    //.setText(mSectionsPagerAdapter.getPageTitle(i)) formerly set text to inbox or friends
